...
namespace Cafe_Asia
{
    public partial class Login : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-8JN0P6E;Initial Catalog=Cafe_Asia;Integrated Security=True");
            ...
            else if(txt_username.Text=="admin" && txt_pwd.Text=="cafe2021")
            {
